...
class QuizSelectionScreen extends JFrame {
    ...
    private void initializeUI() {
        ...
        startButton.addActionListener(e -> {
            ...
            if (selectedQuiz != null && quizIdMap.containsKey(selectedQuiz)) {
                dispose();
                new MultipleChoiceQuiz(quizIdMap.get(selectedQuiz));
            }
        });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new QuizSelectionScreen());
    }
}
...
public class MultipleChoiceQuiz extends JFrame implements ActionListener {
    ...
    public MultipleChoiceQuiz(String quizId) {
        this.quizId = quizId;
        initializeDatabase();
        initializeUI();
